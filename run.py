...
if analyses:
    ...
    try:
        ...
        acq = ses.add_acquisition({'label':'processed'})
    ...
    print(f'>>> ERROR: no analysis containers found in this session')


# rename the analysis files
# os.rename('T1_to_SRI.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_T1_to_SRI.nii.gz')
# os.rename('T1CE_to_SRI.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_T1CE_to_SRI.nii.gz')
# os.rename('T2_to_SRI.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_T2_to_SRI.nii.gz')
# os.rename('FL_to_SRI.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_FL_to_SRI.nii.gz')

# os.rename('brainTumorSegmentation_SRI.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_pred_tumorSegmentation.nii.gz')
# os.rename('brainMask_SRI.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_pred_brainMask.nii.gz')

# os.rename('z_T1_to_SRI_ss.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_T1_SRI_norm_ss.nii.gz')
# os.rename('z_T1CE_to_SRI_ss.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_T1CE_SRI_norm_ss.nii.gz')
# os.rename('z_T2_to_SRI_ss.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_T2_SRI_norm_ss.nii.gz')
# os.rename('z_FL_to_SRI_ss.nii.gz', f'{output_dir}/{sub_id}_{ses_id}_FL_SRI_norm_ss.nii.gz')
